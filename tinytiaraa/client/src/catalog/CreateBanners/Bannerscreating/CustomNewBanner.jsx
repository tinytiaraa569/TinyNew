...
function CustomNewBanner() {
    ...
    useEffect(() => {
        if (id) {
            ...
            axios.get(`${server}/get-custombanner/${id}`)
                .then((response) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                if (id) {
                    // Update logic
                    await axios.put(`${server}/update-custombanner/${id}`, bannerData);
                    ...
                    // Create logic
                    await axios.post(`${server}/custom-create-banners`, bannerData);
                    swal({
                ...
                <div className="w-full m-5 shadow-lg border border-gray-200">
                    ...
                    <div className="flex justify-center">
                        <div className="w-[90%] m-4 shadow-md border border-gray-100 flex justify-between items-center px-3 py-3">
                            <h1 className="text-[18px] text-[#000000cf] pl-7">{id ? 'Custom Edit Banner' : 'Custom New Banner'}</h1>
...
export default CustomNewBanner;
