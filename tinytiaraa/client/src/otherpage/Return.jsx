...
function ReturnPolicy() {
  return (
    ...
    <div className="TermsConsection">
        <h3 className='text-[18px] font-[700]'>Return Policy</h3>
    ...
    <div className="conditions">
        ...
        <li className='conditonssubsection'>
            <h3>Introduction</h3>
            <p>Thank you for choosing Tiny Tiaraa. We are dedicated to providing high-quality kids' jewellery and ensuring your satisfaction. This Return Policy outlines the procedures and conditions for returning Tiny Tiaraa Kids Jewellery products.</p>
            </li>
        <li className='conditonssubsection'>
            ...
            <p>For returns of online purchases</p>
            <ul>
                <li>
                <p>Contact our customer support team to initiate the return request.</p>

                </li>
                <li>
                <p>Follow the instructions provided for returning the product.</p>
                
                </li>
                <li>
                    <p>Upon receipt and inspection of the returned product, the return process will be completed.</p>
                </li>
            </ul>
            ...
            <p>For returns due to defects, damages, or incorrect products</p>
            <ul>
                <li>
            ...
            <h3>Multiple Returns:</h3>
                    <p>Customers may return multiple products, provided each product meets the eligibility criteria outlined above.</p>   
            </li>

            <li className='conditonssubsection'>
            <h3>Return Policy Changes:</h3>
            <p>Tiny Tiaraa reserves the right to modify or update this Return Policy at any time. Any changes will be communicated through our official channels.</p>
            </li>

            <li className='conditonssubsection'>
            <h3>Contact Information</h3>
            <p>For any questions or assistance regarding returns, please contact our customer support team.</p>
            </li>
    ...
    <p>Thank you for choosing Tiny Tiaraa, We value your trust and aim to ensure your satisfaction with our kids jewellery. If you have any questions or need further assistance, please do not hesitate to contact us.</p>
    </div>
